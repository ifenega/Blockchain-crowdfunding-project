        ...
        <AuthBody>
            <div className='flex flex-col text-center items-center'>
                ...
                <div className='text-center flex flex-col gap-1 items-center mb-10'>
                    <h2 className='text-gray/800 font-bold sm:leading-8 sm:text-2xl '>Account created successfully</h2>
                    <p className='text-gray/500 text-xs sm:text-sm sm:leading-5'>Your account has been successfully created, you can proceed to login with your credentials</p>
