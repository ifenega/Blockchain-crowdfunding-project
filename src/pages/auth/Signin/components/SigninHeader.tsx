    ...
    return (
        <div className='flex flex-col text-center items-center'>
            ...
            <div className='text-center flex flex-col gap-1 items-center mb-6'>
                <h2 className='text-gray/800 font-bold sm:leading-8 sm:text-2xl '>Sign in to your account</h2>
                <p className='text-gray/500 text-xs sm:text-sm sm:leading-5'>Provide these details to sign in to your account</p>

            </div>

            <AlertInfo>
                Upon successful sign in you will be prompted to sign in with your metamask details. <span className='underline cursor-pointer '
                    onClick={()=> {
