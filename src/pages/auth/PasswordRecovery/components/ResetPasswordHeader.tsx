    ...
    return (
        <div className='flex flex-col text-center items-center'>
            ...
            <div className='text-center flex flex-col gap-1 items-center mb-6'>
                <h2 className='text-gray/800 font-bold sm:leading-8 sm:text-2xl '>Reset account password</h2>
                <p className='text-gray/500 text-xs sm:text-sm sm:leading-5'>Provide the email address associated with your account</p>
