                ...
                {({ errors, values, setFieldValue, isValid, dirty }) => (
                    <Form>
                        ...
                        <div className='flex flex-col gap-6 items-center mb-[30px] sm:mb-[70px]'>
                            ...
                            <p className='text-gray/500 text-xs sm:text-sm sm:leading-5 '>Don’t have an account?<span className='ml-2'><TextButton text={'Create an account'} action={() => {  CustomToast('info', 'Check toast if it is working', 'Check') }} /></span></p>
                        </div>
